    ...
    export class JogoController {
        ...
        constructor(containerElement, totalCelulas, usarTimer) {
            ...
            switch (totalCelulas) {
                case 4: this.tempoLimite = 30; break;
                case 16: this.tempoLimite = 90; break;  
                case 36: this.tempoLimite = 180; break;
                case 64: this.tempoLimite = 300; break; 
                default: this.tempoLimite = 120;
            }
    ...
    this.inicializarJogo();}
        ...
        setTimeout(() => {
            ...
            this.view.mostrarMensagemFinal({movimentos: this.movimentos, tempo: tempo, vitoria: true});
        }, 300);
    }
        ...
        finalizarJogoPorTempo() {
            ...
            this.view.mostrarMensagemFinal({movimentos: this.movimentos, tempo: tempo, vitoria: false, tempoLimite: this.tempoLimite});
        }, 300);
    }
    ...
    finalizarJogoPorDesistencia() {
            ...
            this.view.mostrarMensagemFinal({movimentos: this.movimentos, tempo: tempo, vitoria: null});
        }, 300);
    }
